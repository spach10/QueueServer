...
var DBFunctions = function(){
	...
	this.insertPreData = function(conn, data){
		...
		return new bpromise(function(resolve, reject){
			var query = conn.query("INSERT INTO work_items (`work_item_id`, `work`, `domain`) VALUES (null, '" + JSON.stringify(data[0].work) + "', '"+ JSON.stringify(data[1].domain) +"');" , function (error, results) {
